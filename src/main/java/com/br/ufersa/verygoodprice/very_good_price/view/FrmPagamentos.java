...
import com.br.ufersa.verygoodprice.very_good_price.model.ItemVenda;
import com.br.ufersa.verygoodprice.very_good_price.model.Vendas;
...
public class FrmPagamentos extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 760, 100));
    ...
    private void btnfinalizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnfinalizarActionPerformed
        ...
        for (int i = 0; i < carrinho.getRowCount(); i++) {
            ...
            //Baixa no estoque
            qtd_estoque = objp.retornaEstoqueAtual(objp.getId());
            qtd_comprada = Integer.parseInt(carrinho.getValueAt(i, 2).toString());
            qtd_atualizada = qtd_estoque - qtd_comprada;
            
            objp.baixaEstoque(objp.getId(), qtd_atualizada);         

            ItemVenda daoitem = new ItemVenda();
